...
# Der Computer soll sich eine Zufallszahl zwischen 1 und 100 ausdenken.
# Der Benutzer soll dann eine Zahl eingeben und bekommt Hinweise, bis er die Zahl erraten hat.
...
# Der Ablauf des Programms soll wie folgt sein (unser "Algorithmus"):
...
#    Ausgabe ob die Zahl zu groß oder zu klein ist
